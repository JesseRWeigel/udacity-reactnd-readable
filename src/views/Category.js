...
import { fetchPostsByCategory, fetchCategories, vote, deletePost, setSorting } from '../actions'
    ...
    return (
      <div>
        ...
        <div style={{ width: '70%', float: 'left' }}>
          <h2>Posts > Category: {this.props.match.params.category} (<Link to='/create-post'>
            Add New
          </Link>)</h2>
